  ...
  return (
    <footer className="mt-24 relative overflow-x-clip pointer-events-auto">
      ...
      <div className="container">
        <div className="border-t border-white/15 py-6 text-sm text-white/50 flex flex-col items-center gap-2">
          <span>Created using React, Next.js, Tailwind CSS and CSS Animation</span>
          <span>
            <a
